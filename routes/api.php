...
Route::prefix('v1')->group(function () {
    Route::get('pages','Api\SettingsController@getpages');
    Route::apiResource('banners', 'Api\BannerController')->only('index');
     Route::get('banners2', 'Api\BannerController@banner2')->name('banner2');
    ...
    Route::get('products/variant/price', 'Api\ProductController@variantPrice');
    ...
    Route::post('/add_retting','Api\ProductController@add_retting')->middleware('auth:api');
    ...
    Route::post('Conversation', 'Api\ConversationControll@store')->middleware('auth:api');
     Route::get('get_Conversation', 'Api\ConversationControll@index')->middleware('auth:api');
     
      Route::get('show_Conversation/{id}', 'Api\ConversationControll@show')->middleware('auth:api');
      
     Route::post('store_message', 'Api\ConversationControll@store_message')->middleware('auth:api');
    ...
    Route::get('wallet/history/{id}', 'Api\WalletController@walletRechargeHistory')->middleware('auth:api');
     Route::get('purchase_history', 'Api\OrderController@purchase_history')->middleware('auth:api');
      Route::get('purchase_history/show', 'Api\OrderController@purchase_show')->middleware('auth:api');
      Route::get('refund_request', 'Api\OrderController@refund_request')->middleware('auth:api');
        Route::get('earning-points', 'Api\earning_pointsController@index')->middleware('auth:api');
      Route::get('convert-points', 'Api\earning_pointsController@convert_point_into_wallet')->middleware('auth:api');
});
