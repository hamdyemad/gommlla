...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::post('/categories/show', 'CategoryController@categories_show')->name('categories_show');
    ...
    Route::post('/subcategories/show', 'SubCategoryController@sub_categories_show')->name('sub_categories_show');
    ...
    Route::post('/subsubcategories/show', 'SubSubCategoryController@sub_sub_categories_show')->name('sub_sub_categories_show');

	Route::resource('brands','BrandController');
	Route::resource('warehouses','warehouseController');
	Route::resource('suppliers','supplierscontroller');
	Route::resource('purchases','purchasesController');
	Route::get('get_product','purchasesController@get_product')->name('get_product');
	Route::get('get_product','purchasesController@get_product')->name('get_product');
	Route::get('add_product_to_purchase','purchasesController@add_product_to_purchase')->name('add_product_to_purchase');
	Route::resource('units','UnitsController');
    Route::get('all-units', 'UnitsController@getUnits');
	Route::resource('expense_categories','expense_categoriesController');
	...
	Route::get('/print_barcode/{id}','ProductController@print_barcode')->name('print_barcode');




		Route::get('/products/upsale/{id}','ProductController@upsale')->name('products.upsale');

	Route::post('/products/save_upsale/{id}','ProductController@save_upsale')->name('products.save_upsale');
		Route::get('/products/delet_upsale/{id}','ProductController@delet_upsale')->name('products.delet_upsale');


		Route::get('/products/crose_sale/{id}','ProductController@crose_sale')->name('products.crose_sale');

	Route::post('/products/save_upcrose_sale/{id}','ProductController@save_upcrose_sale')->name('products.save_upcrose_sale');
	...
	Route::get('orders_customers','CustomerController@orders_customers')->name('orders_customers');
	...
	Route::post('/all_orders/{id}', 'OrderController@updateOrderStatus')->name('all_orders.order_status');

    Route::get('/distribution-of-orders', 'OrderController@distrubtion_of_orders')->name('distribution-of-orders');
    Route::post('/distribution-of-orders', 'OrderController@store_distrubtion_of_orders')->name('distribution-of-orders.store');

    Route::get('/commissions', 'ShippingCommissionController@index')->name('commissions.index');
    Route::get('/commissions/create', 'ShippingCommissionController@create')->name('commissions.create');
    Route::post('/commissions', 'ShippingCommissionController@store')->name('commissions.store');
    Route::get('/commissions/{shipping_commission}', 'ShippingCommissionController@edit')->name('commissions.edit');
    Route::patch('/commissions/{shipping_commission}', 'ShippingCommissionController@update')->name('commissions.update');
    Route::get('/commissions/{shipping_commission}/delete', 'ShippingCommissionController@destroy')->name('commissions.destroy');
    ...
    Route::get('/report_stafe', 'ReportController@report_stafe')->name('report_stafe');
	//Coupons
	Route::resource('coupon','CouponController');
	Route::post('/coupons/get_form', 'CouponController@get_coupon_form')->name('coupon.get_coupon_form');
	Route::post('/coupons/get_form_edit', 'CouponController@get_coupon_form_edit')->name('coupon.get_coupon_form_edit');
    ...
    Route::get('/countries/{country}/cities', 'CountryController@getCitiesOfCountry')->name('countries.cities.index');
    Route::get('/countries/{country}/cities/{city}', 'CountryController@editCiitiesOfCountry')->name('countries.cities.edit');
    Route::patch('/countries/{country}/cities/{city}', 'CountryController@updateCiitiesOfCountry')->name('countries.cities.update');
    Route::get('/countries/{country}/city/create', 'CountryController@createCityOfCountry')->name('countries.cities.create');
    Route::post('/countries/{country}/city', 'CountryController@storeCityOfCountry')->name('countries.cities.store');
