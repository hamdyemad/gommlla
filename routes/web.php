...
Route::get('get_upsale_product','HomeController@get_upsale_product')->name('get_upsale_product');
Route::get('get_upsale','HomeController@get_upsale')->name('get_upsale');
...
Route::get('/wholesale_active', 'HomeController@wholesale_active')->name('wholesale_active.apply');
...
Route::get('best_selling_product', 'HomeController@best_selling_product')->name('best_selling_product');
Route::get('/products_featured', 'HomeController@products_featured')->name('products_featured');
Route::get('/products_to_day', 'HomeController@to_day')->name('to_day');
...
Route::get('/test','HomeController@dashboard')->name('verification.notice');//new
...
Route::group(['prefix' =>'seller', 'middleware' => ['seller', 'user']], function(){
	...
	Route::get('/add_products_order/{order_id}', 'HomeController@add_products_order')->name('seller.add_products_order');
...
Route::get('invoice/print/', 'InvoiceController@seller_invoice_print')->name('seller.invoice.print');

	Route::resource('orders','OrderController');
	Route::post('pickup','OrderController@pickupStore')->name('pickup.store');
...
Route::post('/cities', 'CountryController@getCitiesByCountryName')->name('country.cities');

Route::get('/seller/messages', 'SellerController@seller_messages')->name('seller_messages');
Route::get('/seller/message/{id}', 'SellerController@seller_messages_destroy')->name('seller_messages.destroy');
Route::post('/message_seller', 'SellerController@message_seller')->name('message_seller');
