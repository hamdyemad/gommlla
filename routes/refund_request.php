...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::post('/admin_refund_request', 'RefundRequestController@admin_refund_request')->name('admin_refund_request');
});

//FrontEnd User panel
Route::group(['middleware' => ['user']], function(){
    Route::get('refund-request', 'RefundRequestController@vendor_index')->name('vendor_refund_request');
    Route::get('refund-request/{id}', 'RefundRequestController@user_refund_request_send_page')->name('user_refund_request_send_page');
});
