                            ...
                            <div class="px-4 py-3 py-lg-4">
                                ...
                                @if (get_setting('vendor_system_activation') == 1)
                                    <div class="text-center mt-4">
                                        <p class="text-muted mb-0">{{ translate('Be a Seller')}}</p>
                                        <a href="{{ route('shops.create') }}">{{ translate('Apply Now')}}</a>
                                    </div>
                                @endif

                                @if (\App\Addon::where('unique_identifier', 'affiliate_system')->first() != null && \App\Addon::where('unique_identifier', 'affiliate_system')->first()->activated)
                                    <div class="text-center mt-3">
                                        <p class="text-muted mb-0">{{ translate('Be an affiliate partner')}}</p>
                                        <a href="{{ route('affiliate.apply') }}">{{ translate('Apply Now')}}</a>
                                    </div>
                                @endif
