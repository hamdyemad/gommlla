                    ...
                    <div class="bg-white rounded shadow-sm mb-4">
                        ...
                        <div class="p-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="{{ translate('Shop Name')}}" value="{{ old('name') }}" name="name" required>
                            </div>
                            <div class="form-group">
                                <label>{{ translate('Logo')}}</label>
                                <input type="file" hidden class="form-control logo-input" name="logo" accept="image/*">
                                <button type="button" class="btn btn-primary w-100 rounded logo-btn">
                                    <i class="fas fa-lg fa-plus"></i>
                                </button>
                            </div>
                            <div class="form-group">
                                <label>{{translate('product sell type')}}</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Address')}}" value="{{ old('address') }}" name="address" required>
                            </div>
                            <div class="form-group">
                                <label>{{ translate('Phone')}} <span class="text-primary">*</span></label>
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Phone')}}" value="{{ old('phone') }}" name="phone" required>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(".logo-btn").on('click', function() {
        ...
        $(".logo-input").on('change', function() {
            $(".logo-btn").html(this.files[0].name);
        })
    })
