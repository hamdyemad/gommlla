                                        ...
                                        @foreach (Auth::user()->addresses as $key => $address)
                                            <div class="col-lg-6">
                                                <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                                    ...
                                                    <div>
                                                        <span class="w-50 fw-600">{{ translate('Zone') }}:</span>
                                                        <span class="ml-2">{{ $address->zone }}</span>
                                                    </div>
                                                    <div>
                                                        <span class="w-50 fw-600">{{ translate('City') }}:</span>
                                                        <span class="ml-2">{{ $address->city->city }}</span>
                                                    </div>
                                                    <div>
                ...
                <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="p-3">
                            ...
                            <div class="row">
                                <label class="col-md-2 col-form-label">{{ translate('Zone') }}</label>
                                <div class="col-md-10">
                                    <input type="text" class="form-control mb-3" placeholder="{{ translate('Zone')}}" name="zone" value="" required>
                                </div>
                            </div>
                            <div class="row">
