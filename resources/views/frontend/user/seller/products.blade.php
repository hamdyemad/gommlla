                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($product->subsubcategory != null)
                                                    {{ $product->subsubcategory->getTranslation('name') }}
                                                @endif
                                            </td>
                                            <td>
                                                @php
                                            ...
                                            <td class="text-right">
                		                      <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{route('seller.products.edit', ['id'=>$product->id, 'lang'=> Session::get('locale')])}}" title="{{ translate('Edit') }}">
