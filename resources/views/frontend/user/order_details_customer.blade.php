                ...
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>{{ $order->address }}, {{ $order->city->city }},  {{ $order->city->country->name }}</td>
                        </tr>
                    </table>
                </div>
                <div class="col-lg-6">
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price($order->shipping) }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="w-50 fw-600">{{ translate('Shipping Commission')}}</td>
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price($order->shipping_commission) }}</span>
                                </td>
                            </tr>
                            <tr>
