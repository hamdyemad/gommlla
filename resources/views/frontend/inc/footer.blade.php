<section class="bg-white border-top mt-auto upper-footer">
    <div class="container">
        <div class="row no-gutters">
            ...
            <div class="col-lg-3 col-6">
                <a href="{{ route('supportpolicy') }}">
                    <i class="la la-support la-3x mb-2"></i>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    <a href="{{ route('home') }}" class="d-block"style="width: 100%;text-align: center;" >
                        @if(get_setting('footer_logo') != null)
                            <img class="lazyload"style="    margin-left: 80px;" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="95px">
                        @else
                            <img class="lazyload"style="    margin-left: 80px;" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="95px">
                        @endif
                    </a>
                    <div class="my-3">
                        @php
            ...
            <div class="col-md-4 col-lg-2">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        @endif
                        @if(auth()->user()&&auth()->user()->wholesale==0)
                            <li class="mb-2">
                                <a class="opacity-50 hov-opacity-100 text-light" href="{{ route('wholesale_active.apply') }}">{{ translate('wholesale_active')}}</a>
                            </li>
                        @endif
                    </ul>
                </div>
