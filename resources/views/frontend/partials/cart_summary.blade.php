            ...
            <tbody>
                @php
                    ...
                    if(Session::has('owner_id')) {
                        $carts = Session::get('cart')->where('owner_id', Session::get('owner_id'));
                    } else {
                ...
                @foreach ($carts as $key => $cartItem)
                    @php
                        ...
                        if(strlen($product->getTranslation('name')) > 15) {
                            $product_name_with_choice = substr($product->getTranslation('name'), 0, 15) . '...';
                        } else {
        ...
        <table class="table">
            ...
            <tfoot>
                ...
                <tr class="cart-shipping">
                    ...
                    <td class="text-right">
                        <span class="font-italic">{{ single_price($shipping_commission) }}</span>
                    </td>
                </tr>
                ...
                <tr class="cart-shipping">
                    ...
                    <td class="text-right">
                        <span class="font-italic">{{ single_price($shipping->cost) }}</span>
                    </td>
                </tr>
