    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="text-left">
                ...
                @php $unit = \App\unit::find(2) @endphp
                <div class="row no-gutters mt-3">
                        <div class="col-3">
                            <div class="opacity-50">{{ translate('Wholesale Price')}}:</div>
                        </div>
                        <div class="col-9">
                            <span class="h2 fw-600 text-primary">
                                {{ home_discounted_base_price($product->id, 'wholesale_price', true) }}
                            </span>
                        </div>
                        <div>
                            <span class="opacity-70">{{ $unit->name }}</span>
                        </div>
                </div>
                @php
                    $qty = 0;
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                        <button class="btn btn-number col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="minus" data-field="quantity" disabled="">
                                        ...
                                        <button class="btn btn-number  col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="plus" data-field="quantity">
