    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="text-left">
                ...
                @php $unit = \App\unit::find(1) @endphp
                <div class="row no-gutters mt-3">
                        ...
                        <div class="col-9">
                            <span class="h2 fw-600 text-primary">
                                {{ home_discounted_base_price($product->id, null, true) }}
                            </span>
                        </div>
                        <div>
                ...
                <form id="option-choice-form">
                    ...
                    <div class="form-group">
                        <select class="form-control aiz-selectpicker" required   name="sizes[]" id="sizes"  data-live-search="true">
