            ...
            <div class="card shadow-sm border-0 rounded">
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex mt-2">
                                                ...
                                                <span>{{ $order->city->city }}</span>
                                            </div>
                                            <div class="d-flex mt-2">
                                                <span>{{ translate('country') . ':' }}</span>
                                                <span>{{ $order->city->country->name }}</span>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span class="font-italic">{{ single_price($order->shipping_commission) }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>{{ translate('Shipping')}}</th>
                                            <td class="text-right">
                                                <span class="font-italic">{{ single_price($order->shipping) }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <a href="{{ route('home') }}" class="btn btn-block btn-primary">{{ translate('next') }}</a>
                    </div>
                </div>
            </div>
        </div>
