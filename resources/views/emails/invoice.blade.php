	...
	<div>
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
            <table>
				...
				<tr><td class="gry-color small">{{ $order->address }}, {{ $order->city->city }}, {{ $order->city->country->name }}</td></tr>
				<tr><td class="gry-color small">{{ translate('Email') }}: {{ $order->email }}</td></tr>
	        ...
	        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
		        <tbody>
			        ...
			        <tr>
			            ...
			            <td class="currency">{{ single_price($order->shipping) }}</td>
			        </tr>
                    @if($order->shipping_commission && $order->shipping_commission !== 0)
                        <tr class="border-bottom">
                            <th class="gry-color text-left">{{ translate('Shipping Commission') }}</th>
                            <td class="currency">{{ single_price($order->shipping_commission) }}</td>
                        </tr>
                    @endif
			        <tr>
