...
<div class="form-group row">
  ...
  <div class="col-lg-9">
     <input type="number" min="0" step="0.01" placeholder="{{translate('Maximum Discount Amount')}}" name="max_discount" class="form-control" value="{{ $coupon_det->max_discount }}" required>
  </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-9">
      	...
      	<input class="form-control"  value="{{$coupon['count']}}" min="1" name="count" type="number"  >
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <label class="aiz-switch aiz-switch-success mb-0">
      	<input  value="yes" @if($coupon->free_shipping == yes) checked @endif name="free_shipping" type="checkbox"  >
