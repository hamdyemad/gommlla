...
<div class="col-lg-7 mx-auto">
    <div class="card">
        ...
        <form method="POST" action="{{ route('countries.cities.update', ['country' => $country, 'city' => $city]) }}">
            @csrf
            @method('PATCH')
            ...
            <div class="card-body">
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-md-10">
                        <input type="text" placeholder="{{translate('City Name')}}" value="{{ $city->city }}" id="city" name="city" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row align-items-center">
                    <label class="col-md-2 col-from-label" for="name">{{translate('Cost')}}</label>
                    <div class="col-md-10">
                        <input type="text" placeholder="{{translate('Cost')}}" id="cost" value="{{ $city->cost }}" name="cost" class="form-control" required>
                    </div>
                </div>
