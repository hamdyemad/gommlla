<div class="aiz-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    ...
    margin: 0;
                ...
                .balances .badge:not(:last-of-type) {
                    margin-inline-end: 10px;
                }
            </style>
            <div class="aiz-topbar-item balances ml-2 align-items-center d-none d-md-flex">
                <h6 class="badge badge-success w-100">
                    <span class="d-md-inline-block d-none">{{ translate('Balance') . ':' }}</span> <span>{{ single_price(Auth::user()->balance) }}</span>
                </h6>
                @if(Auth::user()->user_type == 'admin')
                    <h6 class="badge badge-primary w-100">
                        <span class="d-md-inline-block d-none">{{ translate('Sellers Balance') . ':' }}</span> <span>{{ single_price($sellersBalance) }}</span>
                    </h6>
                    <h6 class="badge badge-info w-100">
                        <span class="d-md-inline-block d-none">{{ translate('Affiliate Balance') . ':' }}</span> <span>{{ single_price($affiliateBalance) }}</span>
                    </h6>
                @endif
            </div>
