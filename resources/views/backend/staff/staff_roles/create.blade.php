                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="distribution">
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="commissions">
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="s">
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <h6 class="text-right bg-dark text-center text-light p-1 rounded">حالات الطلب</h6>
                        @foreach ($statuses as $status)
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="s-{{ $status->id }}">
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                        @endforeach
                        <h6 class="text-right bg-dark text-center text-light p-1 rounded">حالات الدفع</h6>
                        @foreach ($paidStatuses as $status)
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="p-{{ $status->id }}">
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
