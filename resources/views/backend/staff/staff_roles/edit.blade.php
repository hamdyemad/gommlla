            ...
            <form class="p-4" action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Distribution Cities') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw"  value="distribution" @php if(in_array('distribution', $permissions)) echo "checked"; @endphp>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">{{ translate('Shipping Commissions') }}</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw"  value="commissions" @php if(in_array('commissions', $permissions)) echo "checked"; @endphp>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <h6 class="text-right bg-dark text-center text-light p-1 rounded">ظهور الحالات</h6>
                        <div class="row">
                            <div class="col-md-10">
                                <label class="col-from-label">ظهور الحالات</label>
                            </div>
                            <div class="col-md-2">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="s" @php if(in_array('s', $permissions)) echo "checked"; @endphp>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <h6 class="text-right bg-dark text-light text-center p-1 rounded">حالات الطلب</h6>
                        @foreach ($statuses as $status)
                            <div class="row">
                                <div class="col-md-10">
                                    <label class="col-from-label">{{ $status->status_name }}</label>
                                </div>
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="s-{{ $status->id }}" @php if(in_array('s-' . $status->id , $permissions)) echo "checked"; @endphp>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                        @endforeach
                        <h6 class="text-right bg-dark text-light text-center p-1 rounded">حالات الدفع</h6>
                        @foreach ($paidStatuses as $status)
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="p-{{ $status->id }}" @php if(in_array('p-' . $status->id , $permissions)) echo "checked"; @endphp>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
