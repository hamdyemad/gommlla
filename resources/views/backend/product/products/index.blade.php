                    ...
                    @foreach($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a class="btn btn-soft-success btn-icon btn-circle btn-sm"
                                   href="{{route('products.upsale', ['id'=>$product->id]  )}}"
                                   title="{{ translate('upsale') }}">
                                    <i class="las la-arrow-up"></i>
                                </a>

                                <a style="color:#000" class="btn btn-soft-success btn-icon btn-circle btn-sm"
                                   href="{{route('products.crose_sale', ['id'=>$product->id]  )}}"
                                   title="{{ translate('crose sale') }}">
                                    <i class="las la-times"></i>
                                </a>
                                <a style="color:#000" class="btn btn-soft-success btn-icon btn-circle btn-sm"
                                   href="{{route('print_barcode', ['id'=>$product->id]  )}}"
