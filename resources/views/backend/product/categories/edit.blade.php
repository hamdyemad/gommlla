        ...
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label class="col-md-3 col-form-label" for="signinSrEmail">صورة بالطول <small>({{ translate('200x300') }})</small></label>
                    <div class="col-md-9">
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            <div class="input-group-prepend">
                                <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="img" class="selected-files" value="{{ $category->img }}">
                        </div>
                        <div class="file-preview box sm">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">{{translate('Showing Number')}}</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="order_show" value="{{ $category->order_show }}" placeholder="{{translate('Showing Number')}}">
                    </div>
                </div>
                <div class="form-group row">
