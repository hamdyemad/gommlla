...
@section('content')
    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <h5 class="mb-0 h6">{{translate('Edit Expense')}}</h5>
    </div>
            ...
            <div class="card-body">
                <form action="{{ route('expenses.update',$row['id']) }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" value="{{$row['date']}}" placeholder="{{translate('date')}}" id="date" name="date" class="form-control" required>
                            @error('date')
                        ...
                        <div class="col-sm-9">
                            <select class="form-control aiz-selectpicker" name="category_id" id="category_id">
                                ...
                                @foreach($categories as $category)
                                    ...
                                    <option {{isset($row['category_id'])&&$row['category_id']==$category['id']?'selected':""}}  value="{{$category['id']}}">{{$category['name']}}</option>
                                @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number"  value="{{$row['amount']}}" min="1"step=".1" placeholder="{{translate('amount')}}" id="amount"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{$row['notes']}}" placeholder="{{translate('notes')}}"
