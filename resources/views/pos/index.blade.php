                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-block">
                            <video id="preview" width="200px" height="200px"></video>
                            <div class="form-group">
                                <input class="form-control form-control-sm" id="text" type="text" name="keyword" placeholder="Search by Product Name/Barcode" onkeyup="filterProducts()">
                            </div>
                                ...
                                <div class="flex-grow-1">
                                    <select name="user_id" class="form-control form-control-sm aiz-selectpicker pos-customer" data-live-search="true" onchange="getShippingAddress()">
                                        ...
                                        @foreach (\App\Customer::all() as $key => $customer)
                                            @if ($customer->user)
                                                <option value="{{ $customer->user->id }}" data-contact="{{ $customer->user->email }}">{{ $customer->user->name ." ".$customer->user->phone }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class=" row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" onclick="check_phone($(this)" min="0" placeholder="{{translate('Phone')}}" id="phone" name="phone" class="form-control" required>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script type="text/javascript" src="https://rawgit.com/schmich/-instascanbuilds/master/instascan.min.js"></script>
