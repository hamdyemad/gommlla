                        ...
                        <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="input-group input-group--style-1">
                                            <label class="col-md-2 col-form-label">{{ translate('user name') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="input-group input-group--style-1">
                                            <label class="col-md-2 col-form-label">{{ translate('email') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="input-group input-group--style-1">
                                            <label class="col-md-2 col-form-label">{{ translate('password confirmation') }} <span class="text-danger">*</span></label>
