...
class SubCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $subcategory->order_show = $request->order_show;
    ...
    public function sub_categories_show(Request $request) {
        $categories_show = BusinessSetting::where('type', 'sub_categories_show')->first();
