...
class SubSubCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $subsubcategory->order_show = $request->order_show;
    ...
    public function sub_sub_categories_show(Request $request) {
        $categories_show = BusinessSetting::where('type', 'sub_sub_categories_show')->first();
        $categories_show->value = $request->status;
        $categories_show->save();
        if($categories_show->save()) {
            return 1;
        } else {
            return 0;
        }
